...
build/linux/armv7: dir mod
	...
	export GOARCH=arm
	export GOARM=7
	$(GOBUILD) -o bin/whoami-dns-linux-$(VER:v%=%)-armv7

build/linux/arm64: dir mod
	export CGO_ENABLED=0
	export GOOS=linux
	export GOARCH=arm64
	$(GOBUILD) -o bin/whoami-dns-linux-$(VER:v%=%)-arm64

build/linux/386: dir mod
	export CGO_ENABLED=0
	export GOOS=linux
	export GOARCH=386
	$(GOBUILD) -o bin/whoami-dns-linux-$(VER:v%=%)-386

build/linux/amd64: dir mod
	export CGO_ENABLED=0
	export GOOS=linux
	export GOARCH=amd64
	$(GOBUILD) -o bin/whoami-dns-linux-$(VER:v%=%)-amd64
...
build/darwin/arm64: dir mod
	...
	export GOOS=darwin
	export GOARCH=arm64
	$(GOBUILD) -o bin/whoami-dns-darwin-$(VER:v%=%)-arm64

build/darwin/amd64: dir mod
	export CGO_ENABLED=0
	export GOOS=darwin
	export GOARCH=amd64
	$(GOBUILD) -o bin/whoami-dns-darwin-$(VER:v%=%)-amd64
...
build/windows/amd64: dir mod
	...
	export GOOS=windows
	export GOARCH=amd64
	$(GOBUILD) -o bin/whoami-dns-windows-$(VER:v%=%)-amd64
